  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <main className="flex-grow">
        ...
        <section className="relative py-16 md:py-24 bg-[url('/images/athlete-test-img-10.jpg')] bg-cover bg-center bg-no-repeat bg-fixed">
        ...
        <section className="relative py-16 md:py-24 bg-[url('/images/athlete-test-img-8.jpg')] bg-cover bg-center bg-no-repeat bg-fixed">
