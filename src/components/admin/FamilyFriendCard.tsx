...
interface FamilyFriendCardProps {
  user: FamilyFriendUser;
  onClick?: () => void;
}

export const FamilyFriendCard: React.FC<FamilyFriendCardProps> = ({ user, onClick }) => {
      ...
      <CardContent className="p-4">
        ...
        <div className="hidden sm:block">
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between text-xs text-gray-500 pt-2 border-t border-gray-100">
              <span>{user.relationship_type || '—'}</span>
            </div>
          </div>
        </div>
        ...
        <div className="flex sm:hidden items-center space-x-3">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="mt-2 text-xs text-gray-500">{user.relationship_type || '—'}</div>
          </div>
        </div>
      </CardContent>
    </Card>
